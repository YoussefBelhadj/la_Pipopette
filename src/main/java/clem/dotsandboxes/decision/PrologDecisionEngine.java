...
import clem.dotsandboxes.GameState.ItemType;
import clem.dotsandboxes.prolog.PrologRunner;
import clem.dotsandboxes.prolog.PrologRunner.PrologException;
import clem.dotsandboxes.textinterface.Values;
...
public class PrologDecisionEngine implements DecisionEngine {
	...
	public Edge makeMove(GameState gameState, Player player, Game game) {
		...
		try {
			response = mRunner.excecute(moveRequestTerm, 
